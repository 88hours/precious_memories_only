...
- (void)performLayout {
    ...
    if ([self.navigationController.viewControllers objectAtIndex:0] == self) {
        ...
        //----------------- xb --------------------
        _deleteButton = [[UIBarButtonItem alloc] initWithTitle:NSLocalizedString(@"Remove", nil) style:UIBarButtonItemStylePlain target:self action:@selector(removeButtonPressed:)];
        // Set appearance
...
- (void)removeButtonPressed:(id)sender {
    ...
    [_delegate photoBrowserDidRemoveFinishModalPresentation:self];
